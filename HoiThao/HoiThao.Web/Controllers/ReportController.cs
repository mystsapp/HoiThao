...
namespace HoiThao.Web.Controllers
{
    public class ReportController : BaseController
    {
        ...
        public ActionResult ConferenceGroupByCountry()
        {
            ...
            DataTable dt = _aseanService.ConferenceGroupByCountry();

            var countryList = _aseanService.GetAllCountry();
            ...
            if (dt != null)
            {
                ...
                {
                    dong++;
                    var listItem = _aseanService.GetAllByCountry(item);
                    dong++;
        ...
        public ActionResult Received()
        {
            ...
            DataTable dt = _aseanService.PaymentReport();
        ...
        public ActionResult PickupAtTheAirport()
        {
            ...
            DataTable dt = _aseanService.PickupReport();
        ...
        public ActionResult BuyAirTicket()
        {
            ...
            DataTable dt = _aseanService.AirticketReport();
        ...
        public ActionResult Tour()
        {
            ...
            DataTable dt = _aseanService.TourReport();
        ...
        public ActionResult ExportHotel(string hotel)
        {
            ...
            DataTable dt = _aseanService.HotelReport(hotel);
        ...
        public ActionResult CheckinList()
        {
            ...
            DataTable dt = _aseanService.CheckinReport();
        ...
        public ActionResult VatBill()
        {
            ...
            DataTable dt = _aseanService.VatReport();
        ...
        public ActionResult Speaker()
        {
            ...
            DataTable dt = _aseanService.SpeakerReport();
